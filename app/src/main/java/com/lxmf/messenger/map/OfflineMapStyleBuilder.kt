...
object OfflineMapStyleBuilder {
    ...
    private const val TAG = "OfflineMapStyleBuilder"
     ...
     */
    fun buildOfflineStyle(mbtilesPath: String, name: String = "Offline Map"): String {
        val style = JSONObject().apply {
            put("version", 8)
            put("name", name)
            put("sources", JSONObject().apply {
                put("openmaptiles", JSONObject().apply {
                    put("type", "vector")
    ...
    fun buildCombinedOfflineStyle(mbtilesPaths: Map<String, String>): String {
        ...
        mbtilesPaths.forEach { (id, path) ->
            sources.put(id, JSONObject().apply {
                put("type", "vector")
